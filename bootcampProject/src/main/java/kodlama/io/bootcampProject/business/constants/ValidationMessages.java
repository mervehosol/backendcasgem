package kodlama.io.bootcampProject.business.constants;
...
public class ValidationMessages {
    public static class User {
        ...
        public static final String FirstNameValid = "First name must be between 2 and 30 characters";
        public static final String LastNameBlank = "Last name is required";
        public static final String LastNameValid = "Last name must be between 2 and 30 characters";
